...
/**
 * Кадр карти: Франція, Італія та Німеччина.
 * Північну межу піднято до 54°, бо Kassel (51.3°) впирався у верхній край.
 */
const VIEW = { lonMin: -5.5, lonMax: 19.0, latMin: 36.0, latMax: 54.0 };
const WIDTH = 1000;
...
async function main() {
  ...
  for (const [iso, key] of [['FR', 'france'], ['IT', 'italy'], ['DE', 'germany']]) {
    const f = byIso(iso);
